...
function addItemRow() {
    ...
    row.innerHTML = `
        ...
        <div class="item-field item-qty"><label>🔢 Kuantiti</label><input type="number" class="item-qty" value="1" min="1" step="1" style="padding:0.4rem 0.5rem; border:1px solid #cbd5e1; border-radius:6px; font-size:0.85rem; width:100%;"></div>
        <div class="item-field item-price"><label>💰 Harga (RM)</label><input type="number" class="item-price" value="0" min="0" step="0.01" style="padding:0.4rem 0.5rem; border:1px solid #cbd5e1; border-radius:6px; font-size:0.85rem; width:100%;"></div>
        <div class="item-field item-subtotal"><label>💵 Jumlah</label><span class="item-subtotal-text" id="subtotal-${itemId}">RM 0.00</span></div>
